...
def show_character_sheet(stdscr, player):
    ...
    while True:
        ...
        character_sheet_window.addstr(4, 1, f"STR: {player.base_st}")
        character_sheet_window.addstr(5, 1, f"DEF: {player.base_df}")
        character_sheet_window.addstr(6, 1, f" AC: {player.base_ac}")
        character_sheet_window.addstr(7, 1, f"MGP: {player.base_mp}")
        character_sheet_window.addstr(8, 1, f"EVA: {player.base_evasion}")
        character_sheet_window.addstr(9, 1, f"CRIT RATE: {player.base_crit_rate}")
        character_sheet_window.addstr(10, 1, f"CRIT DMG: {player.base_crit_dmg}")
        character_sheet_window.addstr(11, 1, f"HP RR: {player.base_hp_rr}")
        character_sheet_window.addstr(12, 1, f"HP RA: {player.base_hp_ra}")
